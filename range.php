...
<body>
    ...
    <div class="container-fluid page">
     <div class=" container row mb-4">
         ...
         <div class="col-md-8 col-7 border-right">
           ...
           <?php
              $range = $_GET['range'];
              $book_view = "SELECT * FROM sellbook WHERE selling_price BETWEEN 0 and '$range'";
   ...
   <script>
       //display dynamically range value
       $(document).ready(function(){
           var drange = "<?php echo $_GET['range']; ?>";
           $(".display-range").html(drange);
       })
   $(document).ready(function(){
